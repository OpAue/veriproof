...
// ──────────────────────────────────────────
const mockExams = [
  { id: 1, title: "중간고사", startAt: "2025-05-01T09:00:00", applicantCount: 32, code: "A1B2C3" },
  { id: 2, title: "기말고사", startAt: "2025-06-15T09:00:00", applicantCount: 0, code: "D4E5F6" },
];
          ...
          <div style={styles.emptyState}>
            <div style={styles.emptyIcon}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <rect x="3" y="4" width="18" height="16" rx="3" stroke="#bbb" strokeWidth="1.5" />
                <path d="M7 10h10M7 14h6" stroke="#bbb" strokeWidth="1.5" strokeLinecap="round" />
              </svg>
            </div>
            <p style={styles.emptyText}>개설된 시험이 없습니다</p>
            <p style={styles.emptySubText}>위의 "새 시험 만들기" 버튼으로 시작하세요</p>
          </div>
        )}
      </div>
    </div>
...
const styles = {
  ...
  loadingText: { fontSize: 14, color: "#999", textAlign: "center", padding: 40 },
